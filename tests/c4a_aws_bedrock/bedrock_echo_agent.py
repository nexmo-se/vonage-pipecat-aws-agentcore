...
async def run_bedrock_echo_agent() -> None:
    ...
    print("Pipecat pipeline with Bedrock LLM running — speak into your browser microphone")
    print("  Audio received → LLM processes → echoed back as audio")
    print(
    ...
    print(f"  LLM config: model={bedrock_model_id}, region={aws_region}")
